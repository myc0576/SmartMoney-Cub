...
| 外部服务集成 | [integrations.md](integrations.md) (7.0KB) | 第三方数据源、只读连接器、格式转换适配器与官方 Agent Skill 矩阵 (TypeSafe) | 新增数据导入或只读市场连接器时 |
...
| 插件体系全景 | [plugins.md](plugins.md) (10.2KB) | 内置插件清单、生命周期钩子、数据模式、外部扩展机制与官方 Agent Skill 插件条目 ([typesafe-ai/skills](https://github.com/typesafe-ai/skills)) | 开发、安装或调试特定插件时 |
